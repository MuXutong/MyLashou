...
public class ShowUnpayOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_unpay_order);
        ...
        mHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 72) {
                    Toast.makeText(ShowUnpayOrderActivity.this,"网络走丢了····",Toast.LENGTH_SHORT).show();
                }
